...
const routes: Routes = [
    ...
    { path: 'dns', component: DnsTableComponent, canActivate: [AuthGuard] },
    ...
    { path: 'can', component: CanTableComponent, canActivate: [AuthGuard] },
    { path: 'gps', component: PositionComponent, canActivate: [AuthGuard] },
